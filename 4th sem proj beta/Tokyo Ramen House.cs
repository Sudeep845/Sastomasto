...
{
    public partial class Tokyo_Ramen_House : Form
    {
        ...
        private void Tokyo_Ramen_House_Load(object sender, EventArgs e)
        {
        ...
        {
            isCheckboxChecked12 = checkBox15.Checked;
            button43.Enabled = button44.Enabled = button45.Enabled = isCheckboxChecked12;
        }
        private void updatetextbox12()
        {
            textBox15.Text = currentValue12.ToString();
        }
        ...
        {
            isCheckboxChecked13 = checkBox14.Checked;
            button40.Enabled = button41.Enabled = button42.Enabled = isCheckboxChecked13;
        }
        private void updatetextbox13()
        {
            textBox14.Text = currentValue13.ToString();
        }
        ...
        {
            isCheckboxChecked14 = checkBox13.Checked;
            button37.Enabled = button38.Enabled = button39.Enabled = isCheckboxChecked14;
        }
        private void updatetextbox14()
        {
            textBox13.Text = currentValue14.ToString();
        }
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            using (MySqlConnection conn = new MySqlConnection(connectionString))
            {
                try
                {
                    ...
                    string itemId = "F34"; // Replace "F1" with actual item ID
                    string query = "UPDATE cart SET c_qty = @c_qty WHERE F_ID = @F_ID";
                    using (MySqlCommand cmd = new MySqlCommand(query, conn))
                    {
                        cmd.Parameters.AddWithValue("@c_qty", quantity);
            ...
            {
                int quantity = int.Parse(textBox4.Text);
                AddToCart("F34", "T.Ramen", quantity); // Update parameters accordingly
            }
        }
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            using (MySqlConnection conn = new MySqlConnection(connectionString))
            {
                try
                {
                    ...
                    string itemId = "F35"; // Replace "F1" with actual item ID
                    string query = "UPDATE cart SET c_qty = @c_qty WHERE F_ID = @F_ID";
                    using (MySqlCommand cmd = new MySqlCommand(query, conn))
                    {
                        cmd.Parameters.AddWithValue("@c_qty", quantity);
            ...
            {
                int quantity = int.Parse(textBox5.Text);
                AddToCart("F35", "M.Ramen", quantity); // Update parameters accordingly
            }
        }
        ...
        private void button16_Click(object sender, EventArgs e)
        {
            using (MySqlConnection conn = new MySqlConnection(connectionString))
            {
                try
                {
                    ...
                    string itemId = "F36"; // Replace "F1" with actual item ID
                    string query = "UPDATE cart SET c_qty = @c_qty WHERE F_ID = @F_ID";
                    using (MySqlCommand cmd = new MySqlCommand(query, conn))
                    {
                        cmd.Parameters.AddWithValue("@c_qty", quantity);
            ...
            {
                int quantity = int.Parse(textBox6.Text);
                AddToCart("F36", "S.Ramen", quantity); // Update parameters accordingly
            }
        }
        ...
        private void button19_Click(object sender, EventArgs e)
        {
            using (MySqlConnection conn = new MySqlConnection(connectionString))
            {
                try
                {
                    ...
                    string itemId = "F28"; // Replace "F1" with actual item ID
                    string query = "UPDATE cart SET c_qty = @c_qty WHERE F_ID = @F_ID";
                    using (MySqlCommand cmd = new MySqlCommand(query, conn))
                    {
                        cmd.Parameters.AddWithValue("@c_qty", quantity);
            ...
            {
                int quantity = int.Parse(textBox7.Text);
                AddToCart("F28", "Veg Sushi", quantity); // Update parameters accordingly
            }
        }
        ...
        private void button25_Click(object sender, EventArgs e)
        {
            using (MySqlConnection conn = new MySqlConnection(connectionString))
            {
                try
                {
                    ...
                    string itemId = "F29"; // Replace "F1" with actual item ID
                    string query = "UPDATE cart SET c_qty = @c_qty WHERE F_ID = @F_ID";
                    using (MySqlCommand cmd = new MySqlCommand(query, conn))
                    {
                        cmd.Parameters.AddWithValue("@c_qty", quantity);
            ...
            {
                int quantity = int.Parse(textBox9.Text);
                AddToCart("F29", "Chi Sushi", quantity); // Update parameters accordingly
            }
        }
        ...
        private void button22_Click(object sender, EventArgs e)
        {
            using (MySqlConnection conn = new MySqlConnection(connectionString))
            {
                try
                {
                    ...
                    string itemId = "F30"; // Replace "F1" with actual item ID
                    string query = "UPDATE cart SET c_qty = @c_qty WHERE F_ID = @F_ID";
                    using (MySqlCommand cmd = new MySqlCommand(query, conn))
                    {
                        cmd.Parameters.AddWithValue("@c_qty", quantity);
            ...
            {
                int quantity = int.Parse(textBox8.Text);
                AddToCart("F30", "Mix Sushi", quantity); // Update parameters accordingly
            }
        }
        ...
        private void button28_Click(object sender, EventArgs e)
        {
            using (MySqlConnection conn = new MySqlConnection(connectionString))
            {
                try
                {
                    ...
                    string itemId = "F31"; // Replace "F1" with actual item ID
                    string query = "UPDATE cart SET c_qty = @c_qty WHERE F_ID = @F_ID";
                    using (MySqlCommand cmd = new MySqlCommand(query, conn))
                    {
                        cmd.Parameters.AddWithValue("@c_qty", quantity);
            ...
            {
                int quantity = int.Parse(textBox10.Text);
                AddToCart("F31", "V.Takoyaki", quantity); // Update parameters accordingly
            }
        }
        ...
        private void button31_Click(object sender, EventArgs e)
        {
            using (MySqlConnection conn = new MySqlConnection(connectionString))
            {
                try
                {
                    ...
                    string itemId = "F32"; // Replace "F1" with actual item ID
                    string query = "UPDATE cart SET c_qty = @c_qty WHERE F_ID = @F_ID";
                    using (MySqlCommand cmd = new MySqlCommand(query, conn))
                    {
                        cmd.Parameters.AddWithValue("@c_qty", quantity);
            ...
            {
                int quantity = int.Parse(textBox11.Text);
                AddToCart("F32", "C.Takoyaki", quantity); // Update parameters accordingly
            }
        }
        ...
        private void button34_Click(object sender, EventArgs e)
        {
            using (MySqlConnection conn = new MySqlConnection(connectionString))
            {
                try
                {
                    ...
                    string itemId = "F33"; // Replace "F1" with actual item ID
                    string query = "UPDATE cart SET c_qty = @c_qty WHERE F_ID = @F_ID";
                    using (MySqlCommand cmd = new MySqlCommand(query, conn))
                    {
                        cmd.Parameters.AddWithValue("@c_qty", quantity);
            ...
            {
                int quantity = int.Parse(textBox12.Text);
                AddToCart("F33", "M.Takoyaki", quantity); // Update parameters accordingly
            }
        }
