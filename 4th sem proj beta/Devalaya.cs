...
{
    public partial class Devalaya : Form
    {
        ...
        {
            isCheckboxChecked12 = checkBox27.Checked;
            button79.Enabled = button80.Enabled = button81.Enabled = isCheckboxChecked12;
        }
        private void updatetextbox12()
        {
            textBox27.Text = currentValue12.ToString();
        }
        ...
        {
            isCheckboxChecked13 = checkBox26.Checked;
            button76.Enabled = button77.Enabled = button78.Enabled = isCheckboxChecked13;
        }
        private void updatetextbox13()
        {
            textBox26.Text = currentValue13.ToString();
        }
        ...
        {
            isCheckboxChecked14 = checkBox25.Checked;
            button73.Enabled = button74.Enabled = button75.Enabled = isCheckboxChecked14;
        }
        private void updatetextbox14()
        {
            textBox25.Text = currentValue14.ToString();
        }
        ...
        {
            isCheckboxChecked15 = checkBox21.Checked;
            button61.Enabled = button62.Enabled = button63.Enabled = isCheckboxChecked15;
        }
        private void updatetextbox15()
        {
            textBox21.Text = currentValue15.ToString();
        }
        ...
        {
            isCheckboxChecked16 = checkBox20.Checked;
            button58.Enabled = button59.Enabled = button60.Enabled = isCheckboxChecked16;
        }
        private void updatetextbox16()
        {
            textBox20.Text = currentValue16.ToString();
        }
        ...
        {
            isCheckboxChecked17 = checkBox19.Checked;
            button55.Enabled = button56.Enabled = button57.Enabled = isCheckboxChecked17;
        }
        private void updatetextbox17()
        {
            textBox19.Text = currentValue17.ToString();
        }
        ...
        {
            isCheckboxChecked18 = checkBox15.Checked;
            button43.Enabled = button44.Enabled = button45.Enabled = isCheckboxChecked18;
        }
        private void updatetextbox18()
        {
            textBox15.Text = currentValue18.ToString();
        }
        ...
        {
            isCheckboxChecked19 = checkBox14.Checked;
            button40.Enabled = button41.Enabled = button42.Enabled = isCheckboxChecked19;
        }
        private void updatetextbox19()
        {
            textBox14.Text = currentValue19.ToString();
        }
        ...
        {
            isCheckboxChecked20 = checkBox13.Checked;
            button37.Enabled = button38.Enabled = button39.Enabled = isCheckboxChecked20;
        }
        private void updatetextbox20()
        {
            textBox13.Text = currentValue20.ToString();
        }
        ...
        private void button61_Click(object sender, EventArgs e)
        {
            ...
            {
                int quantity = int.Parse(textBox21.Text);
                AddToCart("F19", "Cappuchio", quantity); // Update parameters accordingly
            }
        }
