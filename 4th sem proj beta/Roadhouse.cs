...
{
    public partial class Roadhouse : Form
    {
        ...
        private void button28_Click(object sender, EventArgs e)
        {
            ...
            {
                int quantity = int.Parse(textBox10.Text);
                AddToCart("F16", "Veg.Biryani", quantity); // Update parameters accordingly
            }
        }
        ...
        private void button31_Click(object sender, EventArgs e)
        {
            ...
            {
                int quantity = int.Parse(textBox11.Text);
                AddToCart("F17", "Buff.Biryani", quantity); // Update parameters accordingly
            }
        }
        ...
        private void button34_Click(object sender, EventArgs e)
        {
            ...
            {
                int quantity = int.Parse(textBox12.Text);
                AddToCart("F18", "C.Biryani", quantity); // Update parameters accordingly
            }
        }
        ...
        private void button52_Click(object sender, EventArgs e)
        {
            ...
            {
                int quantity = int.Parse(textBox18.Text);
                AddToCart("F21", "Latte", quantity); // Update parameters accordingly
            }
        }
        ...
        private void button79_Click(object sender, EventArgs e)
        {
            ...
            {
                int quantity = int.Parse(textBox27.Text);
                AddToCart("F22", "Coca Cola", quantity); // Update parameters accordingly
            }
        }
